    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 sm:h-11 sm:w-11 items-center justify-center rounded-xl bg-[#E8F8F6] text-[#08A6A0]">
            <Droplets size={22} />
          </div>
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-xl bg-[#08A6A0] px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-semibold text-white shadow-sm transition hover:bg-[#078F8A]"
        >
          <Plus size={16} />
          Add Blood Stock
        </button>
      ...
      {/* BLOOD GROUP CARDS */}
      <div className="mb-6 rounded-2xl border border-[#E2EFED] bg-white p-3.5 sm:p-5 shadow-sm">
        <div className="mb-4 flex items-center justify-between">
          ...
          <span className="rounded-full bg-[#E8F8F6] px-2.5 py-0.5 text-[11px] sm:text-xs font-semibold text-[#08A6A0]">
          ...
          {bloodGroups.map((group) => {
            ...
            return (
              <button
                ...
                className="rounded-xl border border-[#E2EFED] p-2.5 sm:p-3 md:p-4 text-left transition hover:border-[#08A6A0] hover:bg-[#E8F8F6]"
              >
                <div className="mb-2 flex h-8 w-8 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-[#E8F8F6] text-xs sm:text-sm font-bold text-[#08A6A0]">
                  {group}
                </div>

                <p className="text-base sm:text-lg md:text-xl font-bold text-[#073F42]">
                  {units}
                </p>
  ...
  <div className="flex min-w-max gap-1">
    ...
    {[
      ...
      <button
        ...
        className={`rounded-lg px-5 py-2.5 text-sm font-semibold transition ${activeTab === tab
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          ...
                          <p
                            className={`text-xs ${expiryStatus ===
                              "Expired"
                              ? "text-red-600"
                              : expiryStatus ===
                                "Expiring Soon"
          ...
          <tbody className="divide-y divide-gray-100">
            ...
            {filteredRequests.map((request) => (
              ...
              >
                ...
                <td className="px-5 py-4">
                  <span
                    className={`rounded-full px-3 py-1 text-xs font-semibold ${request.priority ===
                      "Emergency"
                ...
                <td className="px-5 py-4">
                  ...
                  <span
                    className={`rounded-full border px-3 py-1 text-xs font-medium ${requestStatusStyles[
                      request.status
                    ]
                      }`}
                  >
        ...
        <div className="space-y-5 p-6">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div>
              ...
              <span
                className={`mt-1 inline-block rounded-full border px-3 py-1 text-xs font-medium ${statusStyles[
        ...
        <div className="space-y-5 p-6">
          ...
          <div className="grid grid-cols-2 gap-5">
            ...
            <div>
              ...
              <span
                className={`mt-1 inline-block rounded-full border px-3 py-1 text-xs font-medium ${requestStatusStyles[
