				...
				<aside className="h-fit rounded-2xl border border-[#E2EFED] bg-white p-2 sm:p-3 shadow-sm">
					<div className="mb-2 rounded-xl bg-[#F1F8F7] px-3 py-2.5">
						<div className="flex items-center gap-2.5">
							<div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#DDF4F0] text-[#087F7A]">
								<Building2 className="h-4 w-4" />
							</div>
							<div className="min-w-0">
								<p className="truncate text-xs sm:text-sm font-bold text-[#173F41]">CareCore Hospital</p>
		...
		<div className="mt-6 rounded-xl border border-[#E2EFED] bg-[#F7FBFA] p-3.5 sm:p-4">
			<div className="flex items-start gap-2.5 sm:gap-3">
				...
				<div>
					...
					<p className="mt-0.5 text-[10px] sm:text-xs leading-4 sm:leading-5 text-[#819596]">These details are visible to patients on appointment confirmations and service communications.</p>
				</div>
			</div>
		</div>
	</div>
